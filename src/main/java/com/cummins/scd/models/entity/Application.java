...
@Entity
@Table(name = "ZMKT7352_DES_CAT_APLICACION")
...
public class Application implements Serializable {
	...
	@Id@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="ZMKT7352_SEC_ID_APP")
    @SequenceGenerator(name="ZMKT7352_SEC_ID_APP", sequenceName="ZMKT7352_SEC_ID_APP", allocationSize=1)
    //private int user_id;
	@Column(name = "ID_APP")
