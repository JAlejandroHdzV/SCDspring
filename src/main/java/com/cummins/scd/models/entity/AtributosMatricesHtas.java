...
import com.cummins.scd.models.entity.AtributosMatricesHtasId;


@Entity
@IdClass (AtributosMatricesHtasId.class)
@Table(name = "ZMKT7352_DES_ATT_MATRICES")


public class AtributosMatricesHtas implements Serializable {
    ...
    private MatrizHtasHd matrizHd;




	public MatrizHtasHd getMatrizHd() {
		return matrizHd;
	}
	public void setMatrizHd(MatrizHtasHd matrizHd) {
